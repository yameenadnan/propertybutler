            ...
            ?>
              ...
              <table id="example2" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <th class="col-md-1">License No</th>
                  <th class="col-md-1">License Start Date</th>
                  <th class="col-md-1">License Expiry Date</th>                  
        ...
        success: function(data) {  
            ...
            if(numFound > 0) {                    
                $.each(data.records,function (i, item) { 
                    ...
                    str += '<tr>';
                    str += '<td class="hidden-xs col-md-1">'+showing_to+'</td>';
                    str += '<td class="col-md-1">'+item.item_descrip+'</td>';                    
                    str += '<td class="col-md-2">'+item.serial_no+'</td>';
                    str += '<td class="col-md-2">'+item.location+'</td>';
                    str += '<td class="col-md-1">'+item.license_no+'</td>';
                    str += '<td class="col-md-1">'+item.license_start_date+'</td>';
                    str += '<td class="col-md-1">'+item.license_expiry_date+'</td>';
                    str += '<td class="col-md-2">'+item.supplier_name+'</td>';                    
                    str += '<td class="col-md-1" style="text-align: center;"><a href="<?php echo base_url('index.php/bms_property/add_annual_renewal');?>/'+item.annual_renewal_id+'" title="Edit"><i class="fa fa-edit"></i></a></td>';
                    str += '</tr>';
                });
