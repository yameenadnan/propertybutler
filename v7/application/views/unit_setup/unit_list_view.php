              ...
              <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-xs-1 no-padding">
                        ...
                        <input class="btn btn-primary" style="margin-left: 3px;" onclick="window.location.href='<?php echo base_url('index.php/bms_unit_setup/add_unit');?>'" value="Add Unit" type="button">
                        <a href="javascript:;" style="margin-left: 3px;" role="button" class="btn btn-primary unit_edit">Edit Units</a>
                  ...
                  <div class="box-body">
                      <table id="example2" class="table table-bordered table-hover table-striped">
                          ...
                          <tr>
                              ...
                              <th>Unit No</th>
                              <th>Block/Street</th>
                              <th id="calcul_base">Sq. Foot / Share Unit</th>
                              <th>Owner Name</th>
                              <th>Unit Status</th>
...
$(document).ready(function () {
    ...
    $('.unit_edit').click(function () {
        window.location.href="<?php echo base_url('index.php/bms_unit_setup/unit_list_edit/');?>"+offset_link+"/"+rows_link+"?property_id="+$('#property_id').val()+'&search_txt='+encodeURIComponent($('#search_txt').val());
        return false;
    });
    ...
    $('.unit_edit_cancel').click(function () {
        $('.content-edit-units').addClass('hide-content');
        $('.content-edit-units').removeClass('show-content');

        $('.content-view-units').removeClass('hide-content');
        $('.content-view-units').addClass('show-content');
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(numFound > 0) {
                ...
                if ( data.records[0].calcul_base == 1 )
                    $('#calcul_base').html('Sq. Foot');
                else if ( data.records[0].calcul_base == 2 )
                    $('#calcul_base').html('Share Unit');
                else
                    $('#calcul_base').html('N/A');
            ...
            if ( data.calcul_base == 1 ) {
                $('.showing_stat').html( $('.showing_stat').html() + ', Total Sq. Foot = ' + data.total)
            } else if ( data.calcul_base == 2 ) {
                $('.showing_stat').html( $('.showing_stat').html() + ', Total Share Unit = ' + data.total)
            }
