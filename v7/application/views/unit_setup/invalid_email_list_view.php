...
function loadContent (offset,rows,flag) {
    ...
    $.ajax({
        type:"post",
        async: true,
        url: '<?php echo base_url('index.php/bms_unit_setup/get_invalid_email_list');?>',
        ...
        success: function(data) {  
            ...
            if(numFound > 0) {                    
                $.each(data.records,function (i, item) { 
                    ...
                    str += '<td>'+item.contact_1+'</td>';
                    str += '<td style="text-align: center;">';
                    str += '<a href="<?php echo base_url('index.php/bms_unit_setup/add_unit');?>/' + item.unit_id + '/?invalid_email=yes" title="Edit"><i class="fa fa-edit"></i></a>';
                    str += '</td>';
                    str += '</tr>';
                });
