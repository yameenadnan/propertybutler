                            ...
                            <?php if(!empty($unit_owner_id) && in_array ($unit_owner_id,array('curr_owner','new'))) { ?>
                               ...
                               <?php } ?>
                                <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                                    ...
                                    <input type="hidden" name="owner[coa_id]" value="<?php echo !empty($owner_hist_info['coa_id']) ? $owner_hist_info['coa_id'] : "";?>" />
                                    <input type="hidden" name="owner[property_id]" value="<?php echo !empty($owner_hist_info['property_id']) ? $owner_hist_info['property_id'] : "";?>" />
                                    <input type="hidden" name="owner[unit_no]" value="<?php echo !empty($owner_hist_info['unit_no']) ? $owner_hist_info['unit_no'] : "";?>" />
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 no-padding" >
                                    <div class="col-md-6 col-sm-6 col-xs-6 no-padding">
                                        <div class="form-group">
                                            <label>Email(Login) * <?php echo empty($owner_hist_info['valid_email'])? ' <span style="color:red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Invalid / Inactive Email)</span>':'';?></label>
                                            ...
                                            <input type="hidden" id="email_addr_original" name="owner[email_addr_old]" class="form-control" value="<?php echo isset($owner_hist_info['email_addr']) && $owner_hist_info['email_addr'] != '' ? $owner_hist_info['email_addr'] : '';?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6" style="padding-right: 0px;">
                                        <div class="form-group">
