              ...
              <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-xs-12">
                        <input class="btn btn-primary" onclick="window.location.href='<?php echo base_url('index.php/bms_rfq/add_rfq');?>'" value="New RFQ" type="button">
                    </div>
...
function loadContent (offset,rows,flag) {
    ...
    $.ajax({
        type:"post",
        async: true,
        url: '<?php echo base_url('index.php/bms_rfq/get_quotation_list');?>',
        ...
        success: function(data) {  
            ...
            $('.notice_det_cls').bind("click",function () {
                $('.modal-body2').load('<?php echo base_url('index.php/bms_rfq/quotation_list/');?>'),function(result){
            ...
            if(flag) {
                if (typeof (history.pushState) != "undefined") {
                    var update_url = '<?php echo base_url('index.php/bms_rfq/quotation_list');?>/'+offset+'/'+rows+'?property_id='+$('#property_id').val()+'&search_txt='+search_txt;
