                        ...
                        <div class="col-md-3 col-xs-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                  ...
                                  <input class="form-control pull-right datepicker" name="start_date" id="start_date" type="text"  value="<?php echo date('d-m-Y',strtotime ( '-1 day' , strtotime ( date('Y-M-d') )));?>" />
                                </div>
                                <!-- /.input group -->
                              </div>
                        </div>
...
$(document).ready(function () {
    ...
    $('.attend_filter').click(function () {
        ...
        if($('#property_id').val() == '') {
            alert('Please choose Property Name'); $('#property_id').focus(); 
            return false;
        }
        ...
        $.ajax({
            type:"post",
            async: true,
            url: '<?php echo base_url('index.php/bms_attendance/get_staff_absence');?>',
            data: {'report_date':$('#start_date').val(),'property_id':$('#property_id').val(),'act_type':'html'},
    ...
    $('.download_excel').click(function (){
        $(".download_excel").append('<form id="download_excel_frm" action="<?php echo base_url('index.php/bms_attendance/get_staff_absence');?>" target="_blank" method="POST">');
   
        $(".download_excel form").append('<input type="hidden" name="report_date" value="'+$('#start_date').val()+'"/>');
