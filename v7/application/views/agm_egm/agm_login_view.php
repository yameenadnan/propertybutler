...
<div class="login-box">
  <div class="login-logo">
    <a href="https://propertybutler.my/index.html"><img src="<?php echo base_url();?>assets/images/2.png" alt="Property Butler" class="img-responsive center-block" /></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form name="bms_login" id="bms_login" action="<?php echo base_url('index.php/bms_agm_egm/login_action').(isset($_GET['return_url']) && $_GET['return_url'] != '' ? '?return_url='.$_GET['return_url'] : '');?>" method="post">
