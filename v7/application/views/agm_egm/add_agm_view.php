    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        ?>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="bms_frm" action="<?php echo base_url('index.php/bms_agm_egm/add_agm_submit');?>" method="post" >
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12 no-padding">
                                ...
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Property Name *</label>
                                    ...
                                    <?php 
                                      ...
                                      <input type="hidden" name="agm_main[agm_id]" value="<?php echo $agm_id;?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-xs-6 dates_div" style="display: none;">
                                <div class="form-group">
                                  <label>AGM Number *</label>
                                  <input class="form-control" name="agm_main[agm_number]" value="<?php echo isset($agm_main['agm_number'])  ? $agm_main['agm_number'] : '';?>" type="number">
                                </div>
                            </div>
                        </div>     
                        
                        <div class="col-md-12 col-xs-12 no-padding dates_div" style="display: none;">
                            <div class="col-md-3 col-xs-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Last AGM Date *</label>
                                    <div class="input-group date">
                                      <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                      </div>
                                      <input class="form-control pull-right datepicker" id="last_agm_date" name="agm_main[agm_last_date]" value="<?php echo isset($agm_main['agm_last_date']) && $agm_main['agm_last_date'] != '' && $agm_main['agm_last_date'] != '0000-00-00' && $agm_main['agm_last_date'] != '1970-01-01' ? date('d-m-Y', strtotime($agm_main['agm_last_date'])) : '';?>" type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-xs-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Minumum Date</label>
                                    <div class="input-group date">
                                      <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                      </div>
                                      <input class="form-control pull-right" id="min_date" value="" disabled="disabled" type="text">
                                    </div>  
                                </div>
                            </div>
                            <div class="col-md-3 col-xs-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Maximum Date</label>
                                    <div class="input-group date">
                                      <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                      </div>
                                      <input class="form-control pull-right" id="max_date" value="" disabled="disabled" type="text">
                                    </div>  
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-xs-6">
                                <div class="form-group">
                                  <label for="exampleInputEmail1">AGM Date</label>
                                    <div class="input-group date">
                                      <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                      </div>
                                      <input class="form-control pull-right datepicker" name="agm_main[agm_date]" value="<?php echo isset($agm_main['agm_date']) && $agm_main['agm_date'] != '' && $agm_main['agm_date'] != '0000-00-00' && $agm_main['agm_date'] != '1970-01-01' ? date('d-m-Y', strtotime($agm_main['agm_date'])) : '';?>" type="text">
                                    </div>  
                                </div>
                            </div>
                        </div>                      
                ...
                if (!empty($agm_type) && in_array($agm_type,array_keys($agm_types))) { 
                    if(!empty($check_list)) {
                        ...
                        <div class="row add_reminder_bottom" style="padding-top: 15px;">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-xs-6">
                                    <div class="form-group">
                                        <label ><?php echo $agm_types[$agm_type];?> Checklist</label>
                                        <input type="text" name="agm[agm_descrip][<?php echo $agm_cnt;?>]" class="form-control" value="<?php echo !empty($val['agm_descrip']) ? $val['agm_descrip'] : '';?>" placeholder="Enter <?php echo $agm_types[$agm_type];?> Checklist" maxlength="250">
                        ...
                        <div class="row add_reminder_bottom" style="padding-top: 15px;">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-xs-6">
                                    <div class="form-group">
                                        <label ><?php echo $agm_types[$agm_type];?> Checklist</label>
                                        <input type="text" name="agm[agm_descrip][<?php echo $agm_cnt;?>]" class="form-control" value="" placeholder="Enter <?php echo $agm_types[$agm_type];?> Checklist" maxlength="250">
                                        <input type="hidden" name="agm[agm_checklist_id][<?php echo $agm_cnt;?>]" value=""/>                                
                                    </div>
                                </div>
               ...
               <?php } ?> 
                ...
                <div class="row add_agm_before_div">
                    <div class="col-md-12 text-right">
                        <button type="button" class="btn btn-success add_agm_btn" id="add_agm_btn" value="0" data-value="<?php echo $agm_cnt;?>" aria-invalid="false">Add <?php echo $agm_types[$agm_type];?> Checklist</button>
                    </div>
...
$(document).ready(function () {
    ...
    $( "#bms_frm" ).validate({
		rules: {
			"agm_main[property_id]": "required",
            "agm_main[agm_type]": "required",
            "agm_main[agm_number]": "required",
            "agm_main[agm_last_date]": "required"    
            
		},
		messages: {
			"agm_main[property_id]": "Please select Property Name",
            "agm_main[agm_type]": "Please select AGM Type",
            "agm_main[agm_number]": "Please enter AGM Number",
            "agm_main[agm_last_date]": "Please select Last AGM Date"
		},
		errorElement: "em",
    ...
    if($('#agm_type').val() != '' && $('#property_id').val() != '') {
        $('.dates_div').css('display','block');
        if($('#last_agm_date').val() != ''){
            calculate_min_max_date($('#last_agm_date').val());
        }
    }
    
    $('#last_agm_date').change(function () {
        //console.log($(this).val());
        if($(this).val() != '') {
            calculate_min_max_date($(this).val());
        }
    });
    ...
    function add_agm (agm_cnt) {
        ...
        str += '<input type="hidden" name="agm[agm_checklist_id]['+agm_cnt+']" value=""/>';                                 
        str += '</div>';
        str += '</div>';
...
function calculate_min_max_date (last_date) {
    $.post( "<?php echo base_url('index.php/bms_agm_egm/getMinMaxDate/');?>"+last_date, function( data ) {
      //console.log(data);
      var data_arr = data.split('~~~');
      $('#min_date').val(data_arr[0]);
      $('#max_date').val(data_arr[1]);
    });
}

$('#agm_type, #property_id').change(function () {
    if($('#agm_type').val() != '' && $('#property_id').val() != '') {
        window.location.href="<?php echo base_url('index.php/bms_agm_egm/add_agm');?>/"+$('#property_id').val()+"/"+$('#agm_type').val()+"/<?php echo (!empty($mode) ? $mode : 'add');?>";
        return false;
    } else {
