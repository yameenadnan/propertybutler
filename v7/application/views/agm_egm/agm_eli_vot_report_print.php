    ...
    <section class="content container-fluid cust-container-fluid">
      ...
      <div class="box box-primary" style="border-top: none;">    
        <div class="col-md-12 col-xs-12" style="padding-bottom: 10px;padding-left:10px !important">
            Number Of Eligible Voters: <b><?php echo !empty($units) ? count($units) : 0;?> </b>           
        </div>
        <div class="box-body">
                ...
                <tbody id="content_tbody">
                    ...
                    if(!empty($units)) {
                        ...
                        <tr>
                            ...
                            <td style="width: 200px;"><?php echo $val['owner_name'];?></td>
                            <td><?php echo !empty($val['ic_no']) ? $val['ic_no'] : ' - ';?></td>
                            <td><?php echo !empty($val['unit_type']) ? ($val['unit_type'] == 1 ? 'Individual' : ($val['unit_type'] == 2 ? 'Company' : ' - ')) : ' - ';?></td>
                            <td><?php echo !empty($val['share_unit']) ? $val['share_unit'] : ' - ';?></td>
                            <td style="width: 200px;"><?php echo !empty($val['proxy_name']) ? $val['proxy_name'] : ' - ';?></td>
                            <td><?php echo !empty($val['proxy_ic_no']) ? $val['proxy_ic_no'] : ' - ';?></td>
                        </tr>
