      ...
      <!--------------------------
        ...
        <div class="row">
                    ...
                    <div class="col-md-3 col-xs-4" style="margin-top: 25px;">
                        <a role="button" class="btn btn-primary" href="<?php echo base_url('index.php/bms_agm_egm/add_agm');?>" >Add AGM</a>
                    </div>
                    <?php } ?>                    
                    ...
                    if(!empty($agm_list)) {
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <a href="<?php echo base_url('index.php/bms_agm_egm/add_agm/'.$val['property_id'].'/'.$val['agm_type'].'/edit/'.$val['agm_id']);?>" title="Edit"><i class="fa fa-edit"></i></a>
                            </td>
...
$(document).ready(function () {
    ...
    $('.list_filter').click(function () {
        ...
        window.location.href="<?php echo base_url('index.php/bms_agm_egm/agm_list/');?>"+$('#property_id').val()+'/'+$('#agm_type').val();
        return false;        
    });
    
    $('.agm_update_cls').bind("click",function () {
        $('.modal-content').css('width','750px');
        $('.modal-body2').load('<?php echo base_url('index.php/bms_agm_egm/agm_details/');?>'+$(this).attr('data-value'),function(result){
