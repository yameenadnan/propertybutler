        ...
        ?>
            ...
            <form role="form" id="bms_frm" action="<?php echo base_url('index.php/bms_agm_egm/set_agm_agenda');?>" method="post" >
                ...
                if(!empty($agm_id)) {
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <div class="col-md-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="agm[agenda_resol][0]" rows="4" id="resol_1"><?php echo !empty($agendas[0]['agenda_resol']) ? str_replace('<br />',"",$agendas[0]['agenda_resol']) : '';?></textarea>
                                            <input type="hidden" name="agm[agm_agenda_id][0]" id="agm_agenda_id_1" value="<?php echo !empty($agendas[0]['agm_agenda_id']) ? $agendas[0]['agm_agenda_id'] : '';?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- /.row -->
                    ...
                    <?php } elseif ( isset ($agendas) && (count($agendas) > 0)  ) { // && $agendas[0]['seq_no'] == 0
                        $cnt = count ($agendas);
                        for( $i=0;$i < ( $cnt + 1 ); $i++ ) {
                            if ( ($i == 0) && $agendas[$cnt]['seq_no'] == 0 ) { ?>
                                <div class="row agenda_div" style="margin: 0 0 15px 0; padding: 5px;border: 1px solid #999;border-radius: 5px;">
                                    <div class="row add_reminder_bottom" style="padding-top: 15px;">
                                        <div class="col-md-12 col-xs-12">
                                            <div class="col-md-12 col-xs-12">
