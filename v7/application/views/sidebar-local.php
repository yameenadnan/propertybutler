    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">        
        <?php // section to setup active slidermenu 
            ...
            = $daily_report_act = $user_access_log_act = $common_doc_cen_act = $human_resource_act =  $unit_setup_act =
         ...
         *
         * */
         if($_SESSION['bms']['user_type'] == 'staff' && (in_array($_SESSION['bms']['staff_id'],array(1229,1273)) || in_array($_SESSION['bms']['designation_id'], array(0)))) { ?>
        ...
        if(($_SESSION['bms']['user_type'] == 'staff' && in_array($_SESSION['bms']['staff_id'],array(1229,1219,1273,1353,1309,1522,1337,1546,1520,1562,1581,1547,1584,1430))) || in_array($_SESSION['bms']['designation_id'], array(10,27,28))) { ?>
           ...
           <?php if($_SESSION['bms']['user_type'] == 'staff' && !in_array($_SESSION['bms']['designation_id'], array(28))) { ?>                 
            ...
            <?php if($_SESSION['bms']['user_type'] == 'staff' && !in_array($_SESSION['bms']['designation_id'], array(28))) { ?>
                <li class="treeview <?php echo in_array($this->uri->segment(2), array('facility_list','add_facility', 'facility_booking_list', 'facility_booking_edit')) ? 'active' : '';?>">
                    <a href="#"><i class="fa fa-industry"></i><span>Facilities</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
       ...
       <?php } ?>
        ...
        <?php } ?>
        <?php } ?>
        <?php if ( $_SESSION['property_under'] == 3 ) { ?>
        ...
        <?php if($_SESSION['bms']['user_type'] == 'staff' && in_array($_SESSION['bms']['staff_id'],array(1229, 1273, 1522))) { ?>
