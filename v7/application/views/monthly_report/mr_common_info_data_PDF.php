                          ...
                          <table class="table table-bordered" style="border: 0px;">
                              ...
                              <tr>
                                  <td colspan="2" style="padding-top: 50px; border: 0;">
                                      <h4 style="font-size: 19px;">General Infos</h4>
                                  </td>
                              ...
                              <tr>
                                  ...
                                  <th style="padding: 3px;">Info Description</th>
                                  <th style="padding: 3px;">Remarks</th>
                              </tr>
                              </thead>
                              <tbody>
                              <?php
                              if ( !empty($common_info_data) )  {
                                  $counter = 0;
                                  foreach ($common_info_data as $key=>$val) { ?>
                                      <tr>
                                          <td style="padding: 3px;"><?php echo ++$counter;?></td>
                                          <td style="padding: 3px;"><?php echo date('d-m-Y', strtotime($val['date']));?></td>
                                          <td style="padding: 3px;"><?php echo $val['info_base'];?></td>
