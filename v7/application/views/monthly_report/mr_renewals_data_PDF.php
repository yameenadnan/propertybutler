                  ...
                  <div class="row" style="margin-top: 15px;">
                      <div class="col-xs-12 col-md-12">
                          <table class="table table-bordered" style="border: 0px;">
                              <tr>
                                  <td colspan="4" style="border: 0;" align="center">
                                      <div style="margin: 0;">
                              ...
                              <tr>
                                  <td colspan="2" style="padding-top: 50px; border: 0;">
                                      <h4 style="font-size: 19px;">Annual Renewals</h4>
                                  </td>
                                  <td colspan="2" align="right" style="padding-top: 50px; border: 0;">
                              ...
                              <tr>
                                  <td colspan="4" style="padding-top: 10px; border: 0; ">&nbsp;</td>
                              </tr>
                              <thead>
                              <tr>
                                  <th style="padding: 3px;">#</th>
                                  <th style="padding: 3px;">Description</th>
                                  <th style="padding: 3px;">Company Incharge</th>
                              ...
                              if ( !empty($renewal_data) )  {
                                  $counter = 0;
                                  foreach ($renewal_data as $key=>$val) { ?>
                                      <tr>
                                          <td style="padding: 3px;"><?php echo ++$counter;?></td>
                                          <td style="padding: 3px;"><?php echo $val['item_descrip'];?></td>
                                          <td style="padding: 3px;"><?php echo $val['supplier_name'];?></td>
                                          <td style="padding: 3px;"><?php echo $val['license_expiry_date'];?></td>
                                      </tr>
                                  <?php }
                              } else { ?>
                                  <tr>
                                      <td colspan="4" class="text-center" style="padding: 3px;">No record found</td>
                                  </tr>
                              <?php } ?>
                              </tbody>
                          </table>
