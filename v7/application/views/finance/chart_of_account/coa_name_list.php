              ...
              <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-xs-12">
                        <input class="btn btn-primary add_btn" value="Add COA Name" type="button">
                    </div>
...
$(document).ready(function () {
    ...
    $('.add_btn').click(function () {
        window.location.href='<?php echo base_url('index.php/bms_chart_of_accounts/coa_acc_form');?>';
        return false;  
    });
...
function loadContent (offset,rows,flag) {
    ...
    $.ajax({
        type:"post",
        async: true,
        url: '<?php echo base_url('index.php/bms_chart_of_accounts/get_coa_name_list');?>',
        ...
        success: function(data) {  
            ...
            if(numFound > 0) {                    
                $.each(data.records,function (i, item) { 
                    ...
                    str += '<a href="<?php echo base_url('index.php/bms_chart_of_accounts/coa_acc_form');?>/'+item.coa_acc_name_id+'" title="Edit"><i class="fa fa-edit"></i></a>';
                    str += '</td>';
