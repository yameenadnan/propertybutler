...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.add_btn').click(function () {
            window.location.href='<?php echo base_url('index.php/bms_fin_ap_cn_dn/add_dn');?>?property_id='+$("#property_id").val();
            return false;
        });
    ...
    function loadContent (offset,rows,flag) {
        ...
        $.ajax({
            type:"post",
            async: true,
            url: '<?php echo base_url('index.php/bms_fin_ap_cn_dn/get_dn_list');?>',
            ...
            success: function(data) {
                ...
                if(numFound > 0) {
                    $.each(data.records,function (i, item) {
                        ...
                        str += '<td><a href="<?php echo base_url().'index.php/bms_fin_ap_cn_dn/dn_details/';?>'+item.ap_dn_id+'">'+item.ap_dn_no+'</a></td>';
                        ...
                        str += '<a href="javascript:;" onclick="printDiv(\'<?php echo base_url('index.php/bms_fin_ap_cn_dn/dn_details');?>/'+item.ap_dn_id+'/download\')" title="Download"><i class="fa fa-download"></i></a>&ensp;';
                        str += '<a href="javascript:;" onclick="printDiv(\'<?php echo base_url('index.php/bms_fin_ap_cn_dn/dn_details');?>/'+item.ap_dn_id+'/print\')" title="Print"><i class="fa fa-print"></i></a>&ensp;';
                        str += '</td>';
                        str += '</tr>';
                    });
