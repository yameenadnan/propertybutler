                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2 col-xs-4">
                        ...
                        <div class="col-md-4 col-xs-12" style="margin-top: 25px;">
                            <input class="btn btn-primary view_btn" value="Receive summary" type="button">
                            <input class="btn btn-primary refund_btn"style="margin-left: 8px;" value="Refund summary" type="button">
                        </div>
...
$(document).ready(function () {
    ...
    $('.view_btn').click(function () {
        ...
        window.location.href='<?php echo base_url('index.php/bms_fin_dp_receive/dp_receive_summary');?>?property_id='+$("#property_id").val()+'&from='+$("#from_date").val()+'&to='+$("#to_date").val()+'&dp_receives=yes';
        return false;  
    });
    ...
    $('.refund_btn').click(function () {
        ...
        window.location.href='<?php echo base_url('index.php/bms_fin_dp_receive/dp_receive_summary');?>?property_id='+$("#property_id").val()+'&from='+$("#from_date").val()+'&to='+$("#to_date").val()+'&dp_refund=yes';
        return false;
    });
