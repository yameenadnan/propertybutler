      ...
      <div class="box-body" style="padding-top: 15px;">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="border: 1px solid #999;border-radius: 2px;">
          <div class="row" style="background-color: #d2cece; height: 50px;" >
            <h3 style="margin-top: 10px;margin-left: 5px;"><?php echo !empty($dp_receive['depo_receive_id']) ? 'Update Deposit('.$dp_receive['doc_ref_no'].')' : 'New Deposit';?> </h3>
          </div>
          <form name="bms_frm" id="bms_frm" method="post" action="<?php echo base_url('index.php/bms_fin_dp_receive/add_dp_receive_submit'); ?>">
            <div class="row" style="padding-top: 15px;padding-bottom:15px;">
              <div class="col-md-12 col-sm-12 col-xs-12 no-padding" >
                <div class="col-md-1 col-xs-3"> Property </div>
                <div class="col-md-3 col-xs-5">
                
                    <select class="form-control" id="property_id" name="dp_receive[property_id]">                 
                  ...
                  <!-- Hidden fields -->
                  <input type="hidden" name="dp_receive[depo_receive_id]" value="<?php echo !empty($dp_receive['depo_receive_id']) ? $dp_receive['depo_receive_id'] : '';?>" />
                  <input type="hidden" name="dp_receive[doc_ref_no]" value="<?php echo !empty($dp_receive['doc_ref_no']) ? $dp_receive['doc_ref_no'] : '';?>" />
                ...
                <div class="col-md-3 col-xs-5">
                    ...
                    <select class="form-control" id="block_id" name="dp_receive[block_id]">
                    <option value="">Select</option> 
                    <?php 
                    if(!empty($blocks)) {
                        foreach ($blocks as $key=>$val) {
                            $selected = isset($dp_receive['block_id']) && $dp_receive['block_id'] == $val['block_id'] ?  'selected="selected" ' : '';
                ...
                <div class="col-md-3 col-xs-5" style="">
                    ...
                    <select name="dp_receive[unit_id]" class="form-control" id="unit_id">                
                    <option value="">Select</option> 
                    <?php 
                    if(!empty($units)) {
                        foreach ($units as $key=>$val) {
                            $selected = isset($dp_receive['unit_id']) && $dp_receive['unit_id'] == $val['unit_id'] ?  'selected="selected" ' : '';
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 15px !important;">
                ...
                <div class="col-md-3 col-xs-5">                  
                  <input type="text" name="dp_receive[deposit_date]" value="<?php echo !empty($dp_receive['deposit_date']) ? date('d-m-Y',strtotime($dp_receive['deposit_date'])) : date("d-m-Y"); ?>" class="form-control datepicker" />
                </div>
                
                <div class="col-md-1 col-xs-3">Bank *</div>
                <div class="col-md-3 col-xs-5">   
                
                    <select class="form-control" id="bank_id" name="dp_receive[bank_id]">
                    <option value="">Select</option> 
                    <?php 
                    if(!empty($banks)) {
                        foreach ($banks as $key=>$val) {
                            $selected = isset($dp_receive['bank_id']) && $dp_receive['bank_id'] == $val['bank_id'] ?  'selected="selected" ' : '';
              ...
              <div class="row">
                  <div class="col-md-12" style="margin-top:15px;"> 
                   ...
                   <div class="col-md-2 col-xs-4">
                        ...
                        <select class="form-control" id="payment_mode" name="dp_receive[payment_mode]">
                            <option value="">Select</option> 
                    
                            <?php $payment_mode = $this->config->item ('payment_mode'); 
                            foreach ($payment_mode as $key=>$val) { 
                                if($key != 5) {
                                    $selected = isset($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == $key ?  'selected="selected" ' : '';
              ...
              <div class="row pay_mode_details pay_mode_2" style="display: none;">
                  <div class="col-md-12" style="margin-top:15px;"> 
                    ...
                    <div class="col-md-3 col-xs-4">
                       <input type="text" name="pm_details[cheq_bank]" value="<?php echo !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 2 && !empty($dp_receive['bank']) ? $dp_receive['bank'] : '';?>" class="form-control">
                    </div>
                    ...
                    <div class="col-md-3 col-xs-4">
                       <input type="text" name="pm_details[cheq_no]" value="<?php echo !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 2 && !empty($dp_receive['cheq_card_txn_no']) ? $dp_receive['cheq_card_txn_no'] : '';?>" class="form-control">
                    </div>
                    <div class="col-md-1 col-xs-4" style="padding-top: 5px;">
                       Date
                    </div>
                    <div class="col-md-3 col-xs-4">
                       <input type="text" name="pm_details[cheq_date]" value="<?php echo !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 2 && !empty($dp_receive['cheq_txn_online_date']) ? date('d-m-Y',strtotime($dp_receive['cheq_txn_online_date'])) : '';?>" class="form-control datepicker">
                    </div>
              ...
              <div class="row pay_mode_details pay_mode_3" style="display: none;">
                  <div class="col-md-12" style="margin-top:15px;"> 
                    ...
                    <div class="col-md-3 col-xs-4">
                       <input type="text" name="pm_details[card_bank]" value="<?php echo !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 3 && !empty($dp_receive['bank']) ? $dp_receive['bank'] : '';?>" class="form-control">
                    </div>
                    ...
                    <div class="col-md-3 col-xs-4">
                       <input type="text" name="pm_details[card_txn_no]" value="<?php echo !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 3 && !empty($dp_receive['cheq_card_txn_no']) ? $dp_receive['cheq_card_txn_no'] : '';?>" class="form-control">
                    </div>
                    <div class="col-md-1 col-xs-4" style="padding-top: 5px;">
                       Card Type
                    </div>
                       ...
                       <select name="pm_details[card_type]" class="form-control" >
                            ...
                            <?php $card_type = $this->config->item ('card_type');                    
                                foreach ($card_type as $key=>$val) {
                                    echo $selected = !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 3 && $key == $dp_receive['online_r_card_type'] ? 'selected="selected"' : '';
                                    echo '<option value="'.$key.'" '.$selected.'>'.$val.'</option>';
                                }                            
                            ?>
              ...
              <div class="row pay_mode_details pay_mode_4" style="display: none;">
                  <div class="col-md-12" style="margin-top:15px;"> 
                    ...
                    <div class="col-md-3 col-xs-4">
                       <input type="text" name="pm_details[online_bank]" value="<?php echo !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 4 && !empty($dp_receive['bank']) ? $dp_receive['bank'] : '';?>" class="form-control">
                    </div>
                    ...
                    <div class="col-md-3 col-xs-4">
                       <input type="text" name="pm_details[online_txn_no]" value="<?php echo !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 4 && !empty($dp_receive['cheq_card_txn_no']) ? $dp_receive['cheq_card_txn_no'] : '';?>" class="form-control" style="-webkit-border-radius: 4px !important; border-radius: 4px !important;">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12" style="margin-top:15px;"> 
                       ...
                       <select name="pm_details[online_type]" class="form-control" >
                            ...
                            <?php $online_type = $this->config->item ('online_type');
                                foreach ($online_type as $key=>$val) {
                                    ...
                                    echo $selected = !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 4 && $key == $dp_receive['online_r_card_type'] ? 'selected="selected"' : '';
                                    echo '<option value="'.$key.'" '.$selected.'>'.$val.'</option>';
                    ...
                    <div class="col-md-3 col-xs-4">
                       <input type="text" name="pm_details[online_date]" value="<?php echo !empty($dp_receive['payment_mode']) && $dp_receive['payment_mode'] == 4 && !empty($dp_receive['cheq_txn_online_date']) ? date('d-m-Y',strtotime($dp_receive['cheq_txn_online_date'])) : '';?>" class="form-control datepicker">
                    </div>
              ...
              <div class="row items_container" >
                ...
                <div class="col-md-12 item_1" style="padding-top: 10px !important;" >
                    <div class="col-md-4">
                        <select name="dp_receive[coa_id]" id="cat_dd_1" class="form-control cat_dd" data-id="1" required="required" >
                            <option value="">Select</option>
                            <?php 
                            
                            foreach ($sales_items as $key=>$val) {
                                
                                if(!empty ($dp_receive['coa_id']) && $dp_receive['coa_id'] == $val['coa_id']) {
                    ...
                    <div class="col-md-5">
                      <input type="text" name="dp_receive[description]" id="desc_txt_id_1" value="<?php echo !empty ($dp_receive['description']) ? $dp_receive['description'] : '';?>" class="form-control">
                    </div>
                    <div class="col-md-3">
                      <input type="number" name="dp_receive[amount]" class="form-control amt_cal" value="<?php echo !empty ($dp_receive['amount']) ? $dp_receive['amount'] : '';?>" required="required">
                    </div>  
          ...
          <!--end default open-->
              ...
              <div class="col-md-12 no-padding" style="padding: 20px 0 10px 0 !important;">
                ...
                <div class="col-md-6 col-xs-12" >
                  <textarea rows="4" name="dp_receive[remarks]" class="form-control" cols="50"><?php echo !empty($dp_receive['remarks'])? $dp_receive['remarks'] : '';?></textarea>
                </div>
              </div>
...
$(document).ready(function () {
    ...
    $( "#bms_frm" ).validate({
      rules: {            
        "dp_receive[property_id]": "required",            
        "dp_receive[block_id]": "required",
        "dp_receive[unit_id]": "required",
        "dp_receive[deposit_date]": "required",
        "dp_receive[bank_id]":"required",
        "dp_receive[paid_amount]":"required",
        "dp_receive[payment_mode]":"required",
      },
      messages: {
        "dp_receive[property_id]": "Please select Property",
        "dp_receive[block_id]": "Please select Block/Street",
        "dp_receive[unit_id]": "Please select Unit",
        "dp_receive[deposit_date]": "Please select Due Date",
        "dp_receive[bank_id]":"Please select Bank",
        "dp_receive[paid_amount]":"Please enter Paid Amount",
        "dp_receive[payment_mode]":"Please select Payment mode",
      },
      errorElement: "em",
...
function set_pay_mode_details () {
    ...
    //$('.'+$("input[name='dp_receive[payment_mode]']:checked").attr('id')).css('display','block');
    //console.log($("input[name='dp_receive[pay_mode]']:checked").val());
}
...
function loadBank (property_id) {
    $.ajax({
        type:"post",
        async: true,
        url: '<?php echo base_url('index.php/bms_fin_dp_receive/get_banks');?>',
        data: {'property_id':$('#property_id').val()},
        datatype:"json", // others: xml, json; default is html
        success: function(data) {  
            /*if(typeof(data.error_msg) != "undefined" &&  data.error_msg == 'invalid access') {
...
function remove_item (id){
    if($('#dp_receive_item_id_'+id).length && $('#dp_receive_item_id_'+id).val() != '') {
        //$('.item_'+id).remove();
        //calc_total_amt ();
        if(confirm('You cannot undo this action. Are you sure want to delete?')) {
            $.ajax({
                type:"post",
                async: true,
                url: '<?php echo base_url('index.php/bms_fin_dp_receive/unset_dp_receive_item');?>',
                data: {'dp_receive_item_id':$('#dp_receive_item_id_'+id).val()},
