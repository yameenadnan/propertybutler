<?php if($key_cnt == 0 && $act_type != 'amend') { ?><div class="col-md-12 no-padding" >
...
?>
<div class="col-md-12  no-padding item_div item_<?php echo ($Bkey+$key_cnt+1);?>" style="padding-top: 10px !important;" >
