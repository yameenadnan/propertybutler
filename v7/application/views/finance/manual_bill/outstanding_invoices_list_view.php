        ...
        <!-- general form elements -->
          ...
          <div class="inv_table_container">
            <div class="box-body inv_table">
              ...
              <table class="table table-hover table-striped" style='page-break-after:always'>
                <tbody>
                    <?php
                        $counter = 1;

                            if( isset($act) && $act == 'pdf') {
                                echo '<tr style="background-color: #e6e6e6;"><th align="center" style="border: 0px;" colspan="8"><div style="margin: 0 auto; text-align: center;">' . "<h4>". $PropertyInfo['jmb_mc_name'] . "</h4></div>";
                            ...
                            <tr style="background-color: #ffffff;">
                                <th colspan="8" <?php if ( $counter != 1) { ?>style="padding-top: 35px !important;"<?php } ?>>Unit No: <?php echo $val['unit_no'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name: <?php echo $val['owner_name'];?></th>
                            </tr>
