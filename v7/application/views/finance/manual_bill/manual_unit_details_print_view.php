                            ...
                            <div class="col-md-12 " style="padding: 0;"  >
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 no-padding" >
                                    ...
                                    <div class="col-md-12 col-xs-12 text-center" style="padding-top: 5px;">
                                        <span style="font-family: 'erasbd'; font-size: 18px;"><?php echo !empty($manual_bill['jmb_mc_name']) ? $manual_bill['jmb_mc_name'] : $manual_bill['property_name'];?> <span style="font-family: 'erasbd'; font-size: 13px;">(665318-M)</span></span>
                                        <div style="font-family: 'erasbd'; font-size: 16px;">Building Management for Residensi Riyang</div>
                                        ...
                                        <div><span style="font-family: 'erasemi';">Phone No: 012-7907556</span><span style="font-family: 'erasemi';">, Email: riyangmgt@gmail.com</span></div>
...
-->
                                        ...
                                        <div class="col-xs-12" style="text-align: left;">
                                            <div class="form-group">
                                        <span style="font-family: 'erasemi';">
                                            <p style="font-size: 13px; font-family: 'erasemi'">Purchasers are requested to fully cooperate by settling all outstanding bills before the payment due date.  Prompt payments are important to ensure the effective management of Residensi Riyang, as well as to sustain the appreciation value of our properties.</p>
                                            ...
                                            <ol  style="font-size: 13px; font-family: 'erasemi'">
                                                ...
                                                <li>We DO NOT accept any CASH payments. Payments are to be made by cheque, bank-in or online transfer, and proof of payment is to be forwarded to <b>riyangmgt@gmail.com</b></li>
                                                <li>All cheque payments should be crossed and made payable to SUNTRACK DEVELOPMENT SDN BHD SC or banked in to UOB A/C No.: 225-303-234-2, with proof of payment (cheque deposit slip) forwarded to us via <b>riyangmgt@gmail.com</b>.</li>
