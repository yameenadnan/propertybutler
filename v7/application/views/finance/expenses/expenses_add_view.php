...
<div class="content-wrapper" id="content_area">
    ...
    <?php if ( !empty($invoice_paid) && $invoice_paid == 'yes' ) { ?>
        <style>
                    ...
                    <form role="form" id="bms_frm" action="<?php echo base_url('index.php/bms_fin_expenses/add_expenses_order');?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row" style="padding-top: 15px;padding-bottom:15px;">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 15px !important;">
                                ...
                                <div class="col-md-4">
                                    <select required class="form-control select2" <?php echo ( !empty($invoice_paid) && $invoice_paid == 'yes' && !empty($poitem['po_id']) )? 'readonly="readonly"':'';?> id="service_provider" name="service_provider">
                                        <option value="">Select</option>
                                        <?php
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" <?php echo ( !empty($invoice_paid) && $invoice_paid == 'yes' )? 'readonly="readonly"':'';?> id="po_number" name="po_number">
                                        <option value="">Select</option>
                                        <?php
										if ( !empty($ponumb) ) {
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 15px !important;">
                                ...
                                <div class="col-md-4">
                                    <input type="text" required name="vendor_inv_no" id="vendor_inv_no" value="<?php echo !empty($poitem['exp_inv_no'])?$poitem['exp_inv_no']:'';?>" required="required" class="form-control">
                                </div>
                            </div>
                        </div>
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value['taxpercent'];?></td>
                                                            <td><?php echo $value['taxamt'];?></td>
                                ...
                                <div class="col-lg-4 col-sm-4">
                                    <table class="table table-clear">
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="curtot" id="curtot" value="<?php echo !empty($pursubitem[0]['invoice_paid_amount'])?$pursubitem[0]['invoice_paid_amount']:$pursubitem[0]['payment_paid_amount']; ?>">
                        ...
                        <?php } else {
                            ...
                            <div class="col-md-12 no-padding" id="withoutPO">
                                    ...
                                    <div class="col-md-12 item_div_1"  style="background-color: #ECF0F5; margin: 10px 0 5px 0; padding: 10px 0 !important; border: 1px solid #999; border-radius: 5px;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select required class="form-control select2 cate" name="items[category][]" data-id="1" id="cate_1">
                                                            <option value="">Select</option>
                                                                <?php
                                                                    $group_name = "";
                                        ...
                                        <div class="col-md-12 no-padding">
                                            <div class="col-md-6 no-padding">
                                                ...
                                                <div class="col-md-3 two-padding-left">
                                                    <div class="form-group">
                                                        <label>Discount Amt</label> <input class="form-control amt_disct" value="<?php echo !empty($po_sub_items[0]['discount_amt'])?$po_sub_items[0]['discount_amt']:'0';?>"  name="items[distamount][]"  data-id="1" id="subdistamount_1" type="number" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 no-padding">
                                                ...
                                                <div class="col-md-3 two-padding-left">
                                                    <div class="form-group">
                                                        <label>Tax (%)</label> <input class="form-control amtitemtaxper" value="<?php echo !empty($po_sub_items[0]['taxpercent']) ? $po_sub_items[0]['taxpercent'] : 0;?>" data-id="1" id="amtitemtaxper_1" name="items[amtitemtaxper][]" type="text" min="0" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3 two-padding-left">
                                                    <div class="form-group">
                                                        <label>Tax Amt</label> <input readonly
                                                            class="form-control amtitemtaxamt" value="<?php echo !empty($po_sub_items[0]['taxamt']) ? $po_sub_items[0]['taxamt'] : 0;?>" 
                                                ...
                                                <div class="col-md-3 two-padding-right">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly class="form-control amt_net" value="<?php echo !empty($po_sub_items[0]['net_amount'])?$po_sub_items[0]['net_amount']:'0';?>"  name="items[netamount][]" data-id="1" id="subnetamount_1" type="number" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>  
                                                    ...
                                                    <div class="col-md-12 item_div_<?php echo ($dataid_incre); ?>" style="background-color: #ECF0F5; margin: 10px 0 5px 0; padding: 10px 0 !important; border: 1px solid #999; border-radius: 5px;">
                                                        <div class="col-md-12 no-padding">
                                                            ...
                                                            <div class="col-md-2 text-right">
                                                                <button type="button" class="btn btn-danger btn-sm delete_sub_btn pull-right" data-value="<?php echo !empty($dataid_incre)? $dataid_incre:''; ?>" data-id="<?php echo !empty($dataid_incre)? $dataid_incre:'';?>">
                                                                        ...
                                                                        <select class="form-control select2 cate" name="items[category][]" data-id="<?php echo $dataid_incre; ?>" id="cate_<?php echo $dataid_incre; ?>">
                                                                            <option value="">Select</option>
                                                                                <?php
                                                                                    $group_name = "";
                                                                                    foreach ($expense_items as $key => $val) :
                                                                                    $selected = isset( $po_sub_items[$counter]['coa_id']) && trim( $po_sub_items[$counter]['coa_id']) == $val['coa_id'] ? 'selected="selected" ' : '';
                                                                                        if ($val['coa_type_name'] != $group_name) {
                                                                                            if ($endLabel) {
                                                                                                echo '</optgroup>';
                                                                                            }
                                                                ...
                                                                <div class="col-md-3 two-padding-left">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control amt_disct"
                                                                            value="<?php echo !empty($valslice['discount_amt']) ? $valslice['discount_amt'] : 0 ; ?>"
                                ...
                                <div class="col-md-12 items_container col-xs-6" style="margin-top: 15px;">
                                    ...
                                    <input type="hidden" name="invoice_paid" id="invoice_paid" value="<?php echo (!empty($invoice_paid) && $invoice_paid == 'yes')? 'yes':'';  ?>">
                    ...
                    <div class="col-md-12 no-padding" style="padding: 10px 0 !important;" id="remarkview">
                            ...
                            <div class="col-md-8">
                                <div class="box-footer text-right" style="border-top: 0px solid #f4f4f4;">
                                    <button type="submit" class="btn btn-primary submit_btn" name="action" value="save_only">Submit</button>
...
<script>
    $(document).ready(function (){
        ...
        <?php if ( !empty($invoice_paid) && $invoice_paid == 'yes') { ?>
        $("#po_number").select2("readonly", true);
        <?php } ?>
        ...
        $("#vendor_inv_no").focus (function () {
            var service_provider_id = $('#service_provider').val();
            if ( service_provider_id.trim() == '' ) {
                alert ('Please select service provide first');
                $('#service_provider').focus();
            }
        });

        $("#vendor_inv_no").blur (function () {
            if ( $(this).val().trim() == '' ) {
                return;
            }
            else {
                var exp_inv_no = $(this).val();
                var property_id = $('#property_id').val();
                var service_provider_id = $('#service_provider').val();
                var exp_inv_id = '<?php echo ( isset($poitem['exp_inv_id']) && $poitem['exp_inv_id'] != '')?$poitem['exp_inv_id']:'0';?>';
                if ( exp_inv_id.trim() == '' )
                    exp_inv_id = 0;

                var data = {
                    'exp_inv_id': exp_inv_id,
                    'exp_inv_no': exp_inv_no,
                ...
                $.ajax({
                    type:"post",
                    async: true,
                    url: '<?php echo base_url('index.php/bms_fin_expenses/validate_vendor_invoice_number');?>/', // Reusing the same function from task creation
                    data: data,
                    datatype:"html", // others: xml, json; default is html
                    beforeSend:function (){ $("#content_area").LoadingOverlay("show");  }, //
                    success: function(data) {
                        if ( data > 0 ) {
                            alert ('Service provider with same invoice number already exists');
    ...
    var exp_cnt = 0;
    var sub_exp_cnt = eval("<?php echo !empty($sub_exp_cnt)?$sub_exp_cnt:0;?>");
    ...
    function getpodetails(po_id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                strap +='<th class="center">Tax (%)</th>';
                strap +='<th class="center">Tax Amount</th>';
                ...
                if(data.length > 0) {
                    $.each(data,function (i, item) {
                        ...
                        strap += '<td>'+item.taxpercent+'</td>';
                        strap += '<td>'+item.taxamt+'</td>';
                    ...
                    strsub +=' </td>';
                    strsub +=' <td class="right"><input  class="form-control curtot" style="width:100px"  type="number" value='+ data[0].total+' readonly name="curtot" onchange="calcuamt();" id="curtot"></td>';
                    strsub +='</tr>';
                   ...
                   // strsub +=' <td class="right"><span id="balance" name="balance">0.00</span></td>';
