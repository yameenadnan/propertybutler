            ...
            <div class="box-body">
                <div class="col-md-12 col-sm-12 col-xs-12" style="border: 1px solid #999;border-radius: 2px;">
                    <div class="row" style="background-color: #d2cece; height: 50px;" >
                        <h3 style="margin-top: 10px;margin-left: 5px;"><?php echo !empty($poitem['ap_dn_id']) ? 'Update Debit Note ('.$poitem['ap_dn_id'].')' : 'New Debit Note';?> </h3>
                    </div>
                    <form role="form" id="bms_frm" action="<?php echo base_url('index.php/bms_fin_ap_cn_dn/add_dn_submit');?>" method="post">
                        ...
                        <div class="row" style="padding-top: 15px;padding-bottom:15px;">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 15px !important;">
                                ...
                                <div class="col-md-4">
                                    <select required class="form-control select2" id="service_provider" name="ap_dn[service_provider_id]">
                                        ...
                                        foreach ($service_provider as $key => $val) {
                                            $selected = !empty($ap_dn['service_provider_id']) && ap_dn['service_provider_id'] == $val['service_provider_id'] ?  'selected="selected" ' : '';
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" id="pay_id" name="ap_dn[pay_id]">
                                        <option value="">Select</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row" style="padding-top: 15px;padding-bottom:15px;">
                                ...
                                <div class="col-md-12 no-padding" style="padding: 10px 0 !important;">
                                    ...
                                    <div class="col-md-6 col-xs-12" >
                                        <textarea rows="4" name="ap_dn[remarks]" class="form-control" cols="50"></textarea>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function (){
        ...
        $( "#bms_frm" ).validate({
            rules: {
                "ap_dn[debit_note_date]": "required",
                "ap_dn[service_provider_id]": "required",
                "ap_dn[pay_id]": "required"
            },
            messages: {
                "ap_dn[debit_note_date]": "Please select Date",
                "ap_dn[service_provider_id]": "Please select Service Provider",
                "ap_dn[pay_id]": "Please select Payment Voucher Number"
            },
            errorElement: "em",
