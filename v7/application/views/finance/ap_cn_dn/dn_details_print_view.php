                                    ...
                                    <table style="width: 100%;" class="table table-bordered table-hover  table-striped">
                                        ...
                                        if(!empty($dn_items)) {
                                            foreach($dn_items as $key=>$val) {
                                                ...
                                                echo "<td align='right' style='padding: 10px; border:1px solid #ddd;'>".(!empty($val['description']) ? $val['description'] : '-')."</td>";
                                                echo "<td align='right' style='padding: 10px; border:1px solid #ddd;'>".(!empty($val['net_amount']) ? number_format($val['net_amount'],2) : '-')."</td>";
                                                echo "</tr>";
                                            }
                                            if($dn_note['total_amount'] > 0) {
                                                echo "<tr><td colspan='2' style='padding: 10px; border:1px solid #ddd;' align='right'> <b>Total Amt</b> </td>";
                                                echo "<td align='right' style='padding: 10px; border:1px solid #ddd;'>". $dn_note['total_amount'] ." </td>";
                                                echo "</tr>";
                                            }
                                        } else {
