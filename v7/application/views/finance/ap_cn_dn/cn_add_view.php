            ...
            <div class="box-body">
                <div class="col-md-12 col-sm-12 col-xs-12" style="border: 1px solid #999;border-radius: 2px;">
                    <div class="row" style="background-color: #d2cece; height: 50px;" >
                        <h3 style="margin-top: 10px;margin-left: 5px;"><?php echo !empty($poitem['ap_cr_id']) ? 'Update Debit Note ('.$poitem['ap_cr_id'].')' : 'New Credit Note';?> </h3>
                    </div>
                    <form role="form" id="bms_frm" action="<?php echo base_url('index.php/bms_fin_ap_cn_dn/add_cn_submit');?>"  method="post">
                        <!-- Hidden fields -->
                        ...
                        <div class="row" style="padding-top: 15px;padding-bottom:15px;">
                            <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" id="property_id" name="ap_cn[property_id]" readonly="readonly">
                                    ...
                                    <input type="hidden" name="ap_cn[ap_cr_id]" value="<?php echo !empty($ap_cn['ap_cr_id']) ? $ap_cn['ap_cr_id'] : '';?>" />
                                    <input type="hidden" name="ap_cn[ap_cr_no]" value="<?php echo !empty($ap_cn['ap_cr_no']) ? $ap_cn['ap_cr_no'] : '';?>" />
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="ap_cn[credit_note_date]" value="<?php echo !empty($ap_cn['credit_note_date']) ? date('d-m-Y',strtotime($ap_cn['credit_note_date'])) : date("d-m-Y"); ?>" class="form-control datepicker">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 15px !important;">
                                ...
                                <div class="col-md-4">
                                    <select required class="form-control select2" id="service_provider" name="ap_cn[service_provider_id]">
                                        <option value="">Select</option>
                                        <?php
                                        foreach ($service_provider as $key => $val) {
                                            $selected = !empty($poitem['service_provider_id']) && $ap_cn['service_provider_id'] == $val['service_provider_id'] ?  'selected="selected" ' : '';
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" id="exp_inv_id" name="ap_cn[invoice_id]">
                                        <option value="">Select</option>
                                        <?php
										if(!empty($ponumb)){
                            ...
                            <div class="row" style="padding-top: 15px;padding-bottom:15px;">
                                ...
                                <div class="col-md-12 no-padding" style="padding-top: 15px !important;" >
                                    ...
                                    <div class="col-md-9 no-padding" >
                                        ...
                                        <div class="col-md-2" style="padding: 0 5px !important;">
                                            <input type="text" class="form-control tot_pay_amt" name="ap_cn[total_amount]" value="0" style="text-align: right;" readonly="true" >
                                        </div>
                                        <div class="col-md-2" style="padding: 0 5px !important;">
                                            <input type="text" class="form-control tot_bal_amt" name="invoice_balance_amount" value="0" style="text-align: right;" readonly="true" >
                                        </div>
                                ...
                                <div class="col-md-12 no-padding" style="padding: 10px 0 !important;">
                                    ...
                                    <div class="col-md-6 col-xs-12" >
                                        <textarea rows="4" name="ap_cn[remarks]" class="form-control" cols="50"><?php echo !empty($ap_cn['remarks'])? $ap_cn['remarks'] : '';?></textarea>
                                    </div>
                                </div>
