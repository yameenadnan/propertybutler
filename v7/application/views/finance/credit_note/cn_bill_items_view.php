...
<div class="col-md-12  no-padding item_<?php echo ($Bkey+1);?>" style="padding-top: 10px !important;" >
    ...
    <div class="col-md-3 no-padding">
        ...
        <select name="items[item_cat_id][]" id="cat_dd_<?php echo ($Bkey+1);?>" class="form-control cat_dd" data-id="<?php echo ($Bkey+1);?>" required>
    ...
    <div class="col-md-5">                    
      ...
      <?php echo get_period_dd($period,(!empty ($Bval['item_period']) ? $Bval['item_period'] : '')); ?>
                    ...
                    <div class="col-md-9 no-padding" >
                        <div class="col-md-6">
                          <input type="text" name="items[item_descrip][]" id="desc_txt_id_<?php echo ($Bkey+1);?>" value="<?php echo !empty ($Bval['item_descrip']) ? $Bval['item_descrip'] : '';?>" class="form-control" readonly="true">
                        </div>
                        <div class="col-md-2">
                          <input type="number" name="items[item_amount][]" id="tot_amt_<?php echo ($Bkey+1);?>" class="form-control tot_amt" value="<?php echo !empty ($Bval['item_amount']) ? $Bval['item_amount'] : '';?>" readonly="true" >
                        </div> 
                        <div class="col-md-2">
                          <input type="number" name="items[adj_amount][]" id="pay_amt_<?php echo ($Bkey+1);?>" class="form-control pay_amt" value="<?php echo !empty ($Bval['paid_amount']) ? $Bval['paid_amount'] : '';?>">
                        </div> 
                        <div class="col-md-2">
                          ...
                          <input type="hidden" name="" id="ori_bal_amt_<?php echo ($Bkey+1);?>" class="form-control" value="<?php echo !empty ($Bval['bal_amount']) ? $Bval['bal_amount'] : '';?>" readonly="true">
                        </div>
