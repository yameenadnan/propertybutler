						...
						<div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 15px !important;">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control select2 show-tick selectpicker " data-live-search="true"  id="po_number"
                                    name="pv_number" data-live-search="true">
                                    <?php
                        ...
                        <div class="col-lg-4 col-sm-5 ml-auto">
                            ...
                            <div class="col-md-12 no-padding" style="padding: 10px 0 !important;">
                                ...
                                <div class="col-md-6 col-xs-12" >
                                    <textarea rows="4" name="rema_val" class="form-control" cols="50">  <?php echo !empty($pv_item['remarks'])? $pv_item['remarks'] : '';?></textarea>
                                </div>
                            </div>
                    ...
                    <div class="po_available">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            <table class="table table-clear">
                                ...
                                <tr>
                                    <td class="text-right"> <strong>Current Payable  (RM)</strong> </td>
                                    <td class="text-right" style="padding-right:50px;"><input  class="form-control curtot" style="width:100px"  type="number" value="<?php echo $expsubitem['total'];?>" name="curtot" onchange="calcuamt();" id="curtot">
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label>Sub Category</label> <select
                                                    class="form-control select2 subcate" name="items[subcategory][]"
                                                    id="subcate_1" data-id="1">
                                                    <option value="">Select</option>
                                                    <?php
                                                   // if($pv_item[]['pv_sub_items']!=''){
                                                        foreach ($pv_sub_items[0]['sub_cat_dd'] as $key => $val) {
                                                        $selected = isset($pv_sub_items[0]['pay_sub_cat_id']) && trim($pv_sub_items[0]['pay_sub_cat_id']) == $val['charge_code_sub_category_id'] ? 'selected="selected" ' : '';
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label>Sub Category</label> <select
                                                            class="form-control select2 subcate" name="items[subcategory][]"
                                                            id="subcate_<?php echo $dataid_incre;?>" data-id="<?php echo $dataid_incre;?>">
                                                            <option value="">Select</option>
                                                            <?php
                                                            if($pv_item['exp_inv_no']!=''){
                                                                foreach ($valslice['pay_sub_cat_dd'] as $key => $val) {
                                                                $selected = isset($valslice['pay_sub_cat_id']) && trim($valslice['pay_sub_cat_id']) == $val['charge_code_sub_category_id'] ? 'selected="selected" ' : '';
                                                                echo "<option value='" . $val['charge_code_sub_category_id'] . "'
                                                                      " . $selected . ">" . $val['charge_code_sub_category_name']. "</option>";
                                                               }
                                                            }
...
<!-- bootstrap datepicker -->
     ...
     <script>
         ...
         $('.add_sub_sop_btn').click(function () {
             ...
             str += '<select class="form-control select2"  name="items[subcategory][]" id="subcate_'+dataid+'"  data-id="'+dataid+'" >';
             str += '<option value="">Select</option>';
             str += '</select>';
             str += '</div>';
             str += '</div>';
...
//Date picker
         ...
         function getpodetails(po_id){
             ...
             $.ajax({
                 type:"post",
                 async: true,
                 url: '<?php echo base_url('index.php/bms_fin_payment/getInvoiceOrderDetails');?>',
                 data: {'po_id':poid},
                 datatype:"json", // others: xml, json; default is html
                 // beforeSend:function (){ $("#content_area").LoadingOverlay("show");  }, //
                 success: function(data) {
                     ...
                     if(data.length > 0) {
                         ...
                         $.each(data,function (i, item) {
                             ...
                             discount += parseInt(item.discount_amt);
                             netamt += parseInt(item.net_amount);
                             strap += '<tr>';
                             strap += '<td>'+(i+1)+'</td>';
                         ...
                         strap += '<th class="text-left">'+qty.toFixed(2)+'</th>';
                         strap +='<th colspan="2"></th>';
                         strap += '<th class="text-left">'+price.toFixed(2)+'</th>';
                         strap += '<th class="text-left">'+discount.toFixed(2)+'</th>';
                         strap += '<th class="text-left">'+netamt.toFixed(2)+'</th>';
                         strap += '</tr></tfoot>';
                         ...
                         strsub +=' <tbody>';
                         strsub +='<tr>';
                         strsub +=' <td class="text-right">';
                         strsub +=' <strong>Total Amount</strong>';
                         strsub +=' </td>';
                         strsub +=' <td class="text-right"  style="padding-right:50px;">'+data[0].subtotal+'</td>';
                         strsub +='</tr>';
                         strsub +='<tr>';
                         strsub +=' <td class="text-right">';
                         strsub +=' <strong>Discount</strong>';
                         strsub +=' </td>';
                         strsub +=' <td class="text-right" style="padding-right:50px;">'+data[0].discounts+'</td>';
                         strsub +='</tr>';
                         strsub +='<tr>';
                         strsub +=' <td class="text-right">';
                         strsub +=' <strong>Tax('+data[0].tax_percent+'%)</strong>';
                         strsub +=' </td>';
                         strsub +=' <td class="text-right" style="padding-right:50px;">'+data[0].tax_amt+'</td>';
                         strsub +='</tr>';
                         strsub +='<tr>';
                         strsub +=' <td class="text-right">';
                         strsub +=' <strong>Grand Total</strong>';
                         strsub +=' </td>';
                         strsub +=' <td class="text-right" style="padding-right:50px;">'+data[0].total+'</td>';
                         strsub +=' <input type="hidden" name="grandtotal" id="grandtotal" value='+ data[0].total+'>';
                         strsub +='</tr>';

                         strsub +='<input type="hidden" name="po_select_pur_order_id" id="pur_order_id" value='+ data[0].exp_inv_id+'>';
                         strsub +='<input type="hidden" name="po_select_po_no" id="po_id" value='+ data[0].exp_id+'>';

                         strsub +='<tr>';
                         strsub +=' <td class="text-right">';
                         strsub +=' <strong>Paid</strong>';
                         strsub +=' </td>';
                         strsub +=' <td class="text-right" style="padding-right:50px;">'+data[0].payment_paid_amount+'</td>';
                         strsub +='</tr>';

                         strsub +='<tr>';
                         strsub +=' <td class="text-right" >';
                         strsub +=' <strong>Current Payable</strong>';
                         strsub +=' </td>';
                         strsub +=' <td class="text-right"><input  class="form-control curtot" style="width:100px"  type="number" name="curtot" onchange="calcuamt();" id="curtot"></td>';
                         strsub +='</tr>';
                         ...
                         strsub +=' </td>';
                         strsub +=' <input type="hidden" name="pendingamt" id="pendingamt" value='+ data[0].payment_pending_amount+'>';
                         strsub +=' <input type="hidden" name="paidamt" id="paidamt" value='+ data[0].payment_paid_amount+'>';
                         strsub +=' <td class="text-right"><span id="balance" name="balance"  style="padding-right:50px;">'+data[0].payment_pending_amount+'</span></td>';
