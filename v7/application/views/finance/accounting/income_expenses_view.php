...
$(document).ready(function () {
    ...
    $('.filter_btn').click(function () {
        ...
        window.location.href='<?php echo base_url('index.php/bms_fin_accounting/income_expenses');?>?property_id='+$("#property_id").val()+'&from_date='+$("#from_date").val()+'&to_date='+$("#to_date").val();
        return false;
    });    
