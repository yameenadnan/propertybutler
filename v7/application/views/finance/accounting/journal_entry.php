...
$(document).ready(function () {    
    ...
    $('.view_btn').click(function () {
        window.location.href='<?php echo base_url('index.php/bms_fin_finance/reminder_letter');?>?property_id='+$("#property_id").val()+'&unit_id='+$("#unit_id").val()+'&from='+$("#from_date").val()+'&to='+$("#to_date").val();
        return false;  
    });
