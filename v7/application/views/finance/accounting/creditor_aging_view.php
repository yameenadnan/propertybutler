              ...
              <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-xs-6" style="padding-top: 25px;">
                        ...
                        <a href="javascript:;" role="button" class="btn btn-primary creditor_aging_btn">Creditor Aging</a>
                    </div>     
...
$(document).ready(function () {
    ...
    $('.filter_btn').click(function () {
        ...
        window.location.href='<?php echo base_url('index.php/bms_fin_accounting/aging_report');?>?property_id='+$("#property_id").val()+'&from='+$("#from_date").val()+'&aging_report=show';
        return false;
    });  
    
    $('.creditor_aging_btn').click(function () {
        if($("#property_id").val() == '') {
            alert('Plase select Property!'); $("#property_id").focus();return false;
        }
        if($("#from_date").val() == '') {
        ...
        //$("#content_area").LoadingOverlay("show");
        //myInterval = setInterval(function(){ alert_msg(); }, 900);
        window.location.href='<?php echo base_url('index.php/bms_fin_accounting/creditor_aging_report');?>?property_id='+$("#property_id").val()+'&from='+$("#from_date").val()+'&aging_report=show';
        return false;
    });  
...
function alert_msg () {
    ...
    alert('Cannot not find Aged Items!');
