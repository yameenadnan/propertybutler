    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        ?>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="bms_frm" action="<?php echo base_url('index.php/bms_jmb_mc/add_agm_submit');?>" method="post" >
...
function calculate_min_max_date (last_date) {
    $.post( "<?php echo base_url('index.php/bms_jmb_mc/getMinMaxDate/');?>"+last_date, function( data ) {
      //console.log(data);
...
$('#agm_type, #property_id').change(function () {
    if($('#agm_type').val() != '' && $('#property_id').val() != '') {
        window.location.href="<?php echo base_url('index.php/bms_jmb_mc/add_agm');?>/"+$('#property_id').val()+"/"+$('#agm_type').val()+"/<?php echo (!empty($mode) ? $mode : 'add');?>";
        return false;
    } else {
